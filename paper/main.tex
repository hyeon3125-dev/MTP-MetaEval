...
agentic, and vendor-specific axes are not benchmarked across vendors, the global
claim ``scaling has saturated'' is itself assumed-not-earned. The contribution is
...
to decide the overhead question there at all---a gap this paper names rather than
fills.
